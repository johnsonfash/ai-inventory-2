...
const QUICK_ACTIONS: CommandItem[] = [
  ...
  { id: "qa-new-recipe",   group: "Quick actions", title: "Build a new recipe / BOM", subtitle: "Inventory / recipes / new", Icon: Workflow,    href: "/inventory/recipes/new", searchTerms: "new recipe bom build bake assemble blend service production component" },
  { id: "qa-log-run",      group: "Quick actions", title: "Log a production run", subtitle: "Inventory / production",     Icon: Factory,      href: "/inventory/production",  searchTerms: "production run batch made produced bake blend assemble service job" },
  { id: "qa-recall",       group: "Quick actions", title: "Start a recall trace", subtitle: "Inventory / recall",         Icon: ShieldAlert,  href: "/inventory/recall",      searchTerms: "recall trace lot batch contamination defect compliance fsma" },
...
const NAVIGATE: CommandItem[] = [
  ...
  { id: "nav-recipes",        group: "Navigate", title: "Recipes & BOMs",        subtitle: "/inventory/recipes",         Icon: Workflow,    href: "/inventory/recipes",          searchTerms: "recipes bom bill of materials production assembly build bake blend formula composition component" },
  { id: "nav-production",     group: "Navigate", title: "Production runs",       subtitle: "/inventory/production",      Icon: Factory,     href: "/inventory/production",       searchTerms: "production runs batches made produced bakes blends assemblies services" },
  { id: "nav-lots",           group: "Navigate", title: "Lots & batches",        subtitle: "/inventory/lots",            Icon: Boxes,       href: "/inventory/lots",             searchTerms: "lots batches expiry batch tracking fefo traceability" },
  { id: "nav-recall",         group: "Navigate", title: "Recall trace",          subtitle: "/inventory/recall",          Icon: ShieldAlert, href: "/inventory/recall",           searchTerms: "recall trace contamination defect fsma compliance batch lot" },
  ...
  { id: "nav-variance",       group: "Navigate", title: "Variance (theoretical vs actual)", subtitle: "/reporting/variance", Icon: Scale,       href: "/reporting/variance",         searchTerms: "variance theoretical actual shrinkage drift recipe production count" },
  { id: "nav-recipe-cost",    group: "Navigate", title: "Recipe cost watch",    subtitle: "/reporting/recipe-cost",     Icon: Calculator,   href: "/reporting/recipe-cost",      searchTerms: "recipe cost watch drift price change margin food cost component" },

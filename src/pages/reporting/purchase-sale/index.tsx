...
const cols: Column<Row>[] = [
  ...
  { key: "purchases", header: "Purchases", align: "right", render: (_, v) => formatPriceFor(v as number) },
  { key: "net", header: "Net", align: "right", render: (_, v) => formatPriceFor(v as number) },
]
...
export default function PurchaseSale() {
  ...
  return (
    ...
    >
      <KpiBand
        items={[
          { title: "Sales", value: formatPrice(totalSales), delta: "+18%", trend: "up", Icon: ArrowUpFromLine, tone: "emerald" },
          { title: "Purchases", value: formatPrice(totalPurchases), delta: "+8%", trend: "up", Icon: ArrowDownToLine, tone: "violet" },
          { title: "Net", value: formatPrice(totalNet), Icon: Wallet, tone: "amber" },

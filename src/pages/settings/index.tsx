...
const GROUPS: { title: string; description: string; tiles: Tile[] }[] = [
  ...
  },
  {
    ...
    tiles: [
      { href: "/settings/payments", title: "Payment methods", description: "Connected processors, payout accounts.", Icon: CreditCard, tone: "violet" },
      { href: "/settings/payments/accounts", title: "Withdrawal accounts", description: "Where revenue lands.", Icon: Banknote, tone: "emerald" },
      { href: "/settings/taxes", title: "Tax rates", description: "Default rates by region or product.", Icon: Tags, tone: "amber" },

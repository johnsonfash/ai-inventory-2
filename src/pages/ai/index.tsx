...
export default function AIChat() {
  ...
  async function send() {
    ...
    try {
      const data = await aiChat({ prompt, context: ctx })
      await typeWriter(String(data.reply ?? ""))
    } catch {
          ...
          <CardContent className="space-y-3">
            ...
            <div className="rounded-lg border p-3 text-sm">
              ...
              <div className="flex flex-col gap-2">
                <Link to="/inventory" className="text-violet-600 hover:underline">
                  Inventory — Items
                </Link>
                <Link to="/reporting/stock" className="text-violet-600 hover:underline">
                  Reporting — Stock
                </Link>
                <Link to="/purchasing/pos" className="text-violet-600 hover:underline">
